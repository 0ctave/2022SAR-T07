...
enterprise = Enterprise(
    ...
    employees=employees, items=items, machine_types=machine_types, machines=machines, inventory=inventory, market_prices=market_prices, auto_sell_items=[item03], item_orders=item_orders
)
