from entersim.sim.enterprise import *  # noqa: F403
from entersim.sim.control import *  # noqa: F403
...
mt01 = MachineType(
    ...
    error_probability_per_hour_of_operation=0.02,
    error_amount_in_percentage=20.0,
)
mt02 = MachineType(
    name="MT02",
    ...
    new_delivery_in_hours=0,
    error_probability_per_hour_of_operation=0.04,
    error_amount_in_percentage=10.0,
)
...
sl_emp01 = SalesEmployee(
    name="SLE01",
    standard_hourly_wage=20,
    overtime_hourly_wage=30,
    max_standard_hours_per_day=8,
    max_overtime_hours_per_day=2,
    working_hours_per_day=8,
    department=sld01,
    sickness_probability_per_hour_worked=0.05,
...
sa_emp01 = SupervisorAdminEmployee(
    name="SAE01",
    standard_hourly_wage=30,
    overtime_hourly_wage=45,
    max_standard_hours_per_day=8,
    max_overtime_hours_per_day=2,
    working_hours_per_day=8,
    department=sad01,
    sickness_probability_per_hour_worked=0.02,
    sickness_duration_in_hours_worked=16,
    remaining_sickness_in_hours_worked=0,
...
p_emp01 = ProductionEmployee(
    ...
    working_hours_per_day=8,
    department=pd01,
    sickness_probability_per_hour_worked=0.03,
    sickness_duration_in_hours_worked=16,
    remaining_sickness_in_hours_worked=0,
...
su_emp01 = SupportEmployee(
    ...
    working_hours_per_day=8,
    department=sd01,
    sickness_probability_per_hour_worked=0.01,
    sickness_duration_in_hours_worked=16,
    remaining_sickness_in_hours_worked=0,
...
inventory = Inventory(item_quantities=[ItemQuantity(item=item01, quantity=200)], funds_in_eur=20000)

market_prices = [ItemPrice(item=item01, unit_price=2), ItemPrice(item=item02, unit_price=4), ItemPrice(item=item03, unit_price=200)]
...
enterprise = Enterprise(
    ...
    departments=departments, employees=employees, items=items, machine_types=machine_types, machines=machines, inventory=inventory, market_prices=market_prices, auto_sell_items=[item03], item_orders=item_orders
)
